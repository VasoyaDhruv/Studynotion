...
const About = () => {
  return (
    <div className='m-[100px] text-white w-11/12 max-w-maxContent mx-auto'>
        {/* section 1 */}
        <section className='bg-richblack-700'>
            <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                    ...
                    <p className='smx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>
                        ...
                        technologies, and nurturing a vibrant learning community.</p>
                </header>
        ...
        <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>     
            {/* founding story div */}
            <div className='flex flex-co; items-center gap-10 lg:flex-row justify-between'>
                ...
                <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                    ...
                    <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>Our e-learning platform was born out of a shared vision and passion for
                         transforming education. It all began with a group of educators, technologists, and
                          lifelong learners who recognized the need for accessible, flexible, and high-quality learning opportunities in a rapidly evolving digital world.</p>
                    <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>As experienced educators ourselves, we witnessed firsthand the limitations 
                        ...
                        boundaries. We envisioned a platform that could bridge these gaps and empower individuals from all walks of life to unlock their full potential.</p>
                </div>
                <div>
                    <img alt='' src={FoundingStory}
                    className='shadow-[0_0_100px_-30px] shadow-[#FC6767]'/> 
                </div>

            </div>

            {/* vision and mission div */}
            <div className='flex flex-row items-center lg:gap-10 lg:felx-col justify-between'>
                <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                    ...
                    <p className="text-base font-medium text-richblack-300 lg:w-[95%]">With this vision in mind, we set out on a journey to create an e-learning
                ...
                <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                    ...
                    <p className="text-base font-medium text-richblack-300 lg:w-[95%]">our mission goes beyond just delivering courses online. We wanted to create a vibrant 
        ...
        {/* section 5 */}
        <section className=' mb-[140px] items-center mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white'>
            <LearningGrid/>
            <ContactFormSection/>
        </section>
