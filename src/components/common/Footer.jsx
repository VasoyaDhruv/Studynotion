...
const Footer = () => {
  return (
    <div className='bg-richblack-800'>
      <div className='flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14'>
        <div className='border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700'>
          ...
          <div className='lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3'>
            ...
            <div className='w-[48%] lg:w-[30%] flex-col gap-2 mt-2 lg:pl-0'>
              <h1 className='text-richblack-50 font-semibold text-[16px]'>
                Resources</h1>
              <div>
                {
      ...
      <div className='flex flex-row w-11/12 max-w-maxContent items-center justify-between text-richblack-400 mx-auto pb-14 text-sm'>
        {/* section 1 */}
            ...
            {BottomFooter.map((ele, i) => {
              return(
                ...
                className={`${
                  ...
                  ? ""
                  : "border-r border-richblack-700 cursor-pointer hover:text-richblack-50 transition-all duration-300"
                } px-3`}>
                  <Link to={ele.split(" ").join("-").toLocaleLowerCase()}>
                    {ele}
                  </Link>
