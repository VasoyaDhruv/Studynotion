...
export default function VideoDetailsSidebar({ setReviewModal }) {
  ...
  useEffect(() => {
    if (!courseSectionData.length || !courseEntireData || !location.pathname) return;
    ...
    const currentSubSection = currentSection.subSection.find((subSection) => subSection._id === subSectionId);
  ...
  return (
    <div className="flex h-[calc(100vh-3.5rem)] w-[320px] max-w-[350px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800">
      ...
      {/* Render Section and Subsections */}
