                ...
                <div className='text-2xl font-bold text-richblack-5'>
                    ...
                    {totalAmount > 0 || totalStudents > 0 ? (
                        ...
                        <div className='flex-1 bg-richblack-800 p-6 rounded-md' >
                            <p className='text-richblack-5 font-bold text-lg'>Visualize</p>
                            <p className='text-richblack-50 font-medium text-xl mt-4'>Not Enough Data To Visualize</p>
                        </div>
                    )}
                    {/* Total statistics */}
                           ...
                           <div className='mt-3 w-full'>
                             ...
                             <div className='mt-1 flex items-center space-x-2'>
                                <p className='text-xs font-medium text-richblack-300'>
                                    {course.studentsEnrolled.length} students</p>
